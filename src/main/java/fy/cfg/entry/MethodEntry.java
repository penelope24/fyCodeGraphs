...
import fy.cfg.frontend.Visualizer;
...
public class MethodEntry{
    ...
    public static void gen(MethodDeclaration n, VarVisitor varVisitor, String output, Properties prop) throws IOException {
        // core
...
//        Visualizer.generate_png("src/main/resources/graph.png", c.get(0));
    }
